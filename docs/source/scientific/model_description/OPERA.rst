...
https://multimodelling.readthedocs.io/en/latest/energy_models/OPERA/index.html
...
| concepts are                 | and all greenhouse gas emissions of   |
|                              | the Netherlands                       |
...
| flexibility options:         | are salt caverns                      |
|                              |                                       |
| What type of flexibility     | (space-specific), batteries, hydrogen |
| options are included         | storage, and a                        |
|                              |                                       |
| in the model?                | significant range of conversion       |
|                              | techniques.                           |
|                              |                                       |
|                              | **Additional comments/remarks**:      |
|                              |                                       |
...
| scale does the              |                                        |
|                             | Per run, the calculations are done on  |
| model have?                 | an annual basis in                     |
|                             |                                        |
|                             | the model.                             |
+-----------------------------+----------------------------------------+
